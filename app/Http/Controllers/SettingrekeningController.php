...
class SettingrekeningController extends Controller
{
    ...
    function api(Request $request)
    {
        ...
        if ($request->tmrekening_akun_kelompok_jenis_objek_id != 0) {
            ...
            $data->join(
                'tmrekening_akun_kelompok_jenis_objeks', function ($join) use ($tmrekening_akun_kelompok_jenis_id) {
            ...
            $data->join(
                'tmrekening_akun_kelompok_jenis_objeks', function ($join) {
                    $join->on('tmrekening_akun_kelompok_jenis_objek_rincians.tmrekening_akun_kelompok_jenis_objek_id', '=', 'tmrekening_akun_kelompok_jenis_objeks.id');
                }
            );
            ...
            $data->join(
                'tmrekening_akun_kelompok_jenis', function ($join) use ($tmrekening_akun_kelompok_id) {
            ...
            $data->join(
                'tmrekening_akun_kelompok_jenis', function ($join) {
                    $join->on('tmrekening_akun_kelompok_jenis_objeks.tmrekening_akun_kelompok_jenis_id', '=', 'tmrekening_akun_kelompok_jenis.id');
                }
            );
            ...
            $data->join(
                'tmrekening_akun_kelompoks', function ($join) use ($tmrekening_akun_id) {
    ...
    public function create(Request $request)
    {
        ...
        $tmrekening_akuns   = Tmrekening_akun::select('id', 'kd_rek_akun', 'nm_rek_akun')->get();
        return view(
            $this->view . 'setting_form', compact(
                'title',
                'route',
                'toolbar',
                'tmrekening_akuns',
    ...
    public function show($id)
    {
        ...
        $tmrekening_akuns   = Tmrekening_akun::select('id', 'kd_rek_akun', 'nm_rek_akun')->get();
        return view(
            $this->view . 'index_rincian', compact(
                'title',
                'nama_rincian',
                'rincian_id',
                'route',
