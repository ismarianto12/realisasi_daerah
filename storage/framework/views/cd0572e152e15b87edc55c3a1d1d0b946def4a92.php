                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="tmrekening_akun_kelompok_id"
                                        class="col-md-3 text-right"><strong>Rek. Kelompok</strong></label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="tmrekening_akun_kelompok_jenis_id"
                                        class="col-md-3 text-right"><strong>Rek. Jenis</strong></label>
                                    <div class="col-sm-4">
                                ...
                                <div class="form-group form-show-validation row">
                                    <label for="tmrekening_akun_kelompok_jenis_id"
                                        class="col-md-3 text-right"><strong>Jenis file</strong></label>
                                    <div class="col-sm-4">
