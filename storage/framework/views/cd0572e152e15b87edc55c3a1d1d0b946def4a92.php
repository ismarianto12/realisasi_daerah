            ...
            $('#tampilkan').click(function(e) {
                ...
                if (tmsikd_satker_id == '') {
                    ...
                    if (jenis == '' || jenis == 0) {
                        ...
                        if (jenis == 'pdf') {
                            window.open("<?php echo e(route('laporan.action_all')); ?>?tahun_id=" + tahun_id +
                                "&tmsikd_satker_id=" + tmsikd_satker_id + "&dari=" + dari + "&sampai=" +
                                sampai + "&rekjenis_id=" + rekjenis_id + '&jenis=' + jenis, '_blank');
                        } else {
                            window.location.href = "<?php echo e(route('laporan.action_all')); ?>?tahun_id=" +
