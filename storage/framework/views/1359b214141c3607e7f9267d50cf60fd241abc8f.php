...
<div style="float:left">
    <img src="<?php echo e(asset('assets/template/img/logo_tangsel.png')); ?>" style="width: 60px;height:60px;margin-top:25px">
</div>
...
<table>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><b><?php echo e(number_format($trek_jenis,0,0,'.')); ?></b></td>
        ...
        <tr>
            ...
            <td><b><?php echo e(number_format($trek_rincian,0,0,'.')); ?></b></td>
            <td><b><?php echo e(number_format($sobj,0,0,'.')); ?></b></td>
            <td></td>
        </tr>
        <?php
        ...
        <tr>
            ...
            <td><i><?php echo e(number_format($trek_rincian_sub,0,0,'.')); ?></i></td>
            <td></b><?php echo e(number_format($srinci,0,0,'.')); ?></b></td>
            <td></td>
        </tr>
