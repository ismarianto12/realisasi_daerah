    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                ...
                <a href="#" to="<?php echo e(route('user.create')); ?>" class="tambah btn btn-secondary btn-round">Tambah Hak
                    Akses</a>
            </div>
        </div>
    </div>
...
<script>
    $(document).ready(function () { 
        $('#datauser').DataTable({
            ...
            serverSide: true,
            ajax: {
                url: "<?php echo e(Url('user_datatable')); ?>",
            },
            columns: [
            {
                data: 'DT_RowIndex',
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp64\www\retribusi\resources\views/user/user_list.blade.php ENDPATH**/ ?>