                    ...
                    <ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
                        ...
                        <?php if($level != 3): ?>
                            <li class="nav-item dropdown hidden-caret">
                                ...
                                <ul class="dropdown-menu notif-box animated fadeIn" aria-labelledby="notifDropdown">
                                    ...
                                    <li>
                                        <a class="see-all" href="<?php echo e(route('pendapatan.index')); ?>">Lihat Semua
                                            Pendapatan
                                ...
                                <div class="quick-actions-scroll scrollbar-outer">
                                    <div class="quick-actions-items">
                                        <div class="row m-0">
                                            ...
                                            <a class="col-6 col-md-4 p-0" href="<?php echo e(url('laporan/perbulan')); ?>"
                                                target="_blank">
                                                <div class="quick-actions-item">
                        ...
                        <li class="nav-item dropdown hidden-caret">
                            <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#"
                                aria-expanded="false">
                                <div class="avatar-sm">
                                    <img src="<?php echo asset('./file/photo_user/'.Properti_app::propuser('photo')) ?>" alt="..." class="avatar-img rounded-circle"
                                        onerror="this.src='<?php echo e(asset('assets/template/img/no-image.png')); ?>'">
                                </div>
                            </a>
                            <ul class="dropdown-menu dropdown-user animated fadeIn">
                                <div class="dropdown-user-scroll scrollbar-outer">
                                    <li>
                                        <div class="user-box">
                                            <div class="avatar-lg"><img src="<?php echo asset('./file/photo_user/'.Properti_app::propuser('photo')) ?>" alt="image profile"
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright ml-auto">
                        <?php
                            echo date('Y');
                        ?> <i class="fa fa-heart heart text-danger"></i> by <a href="#"> copyright
                            <?php echo e(date('Y')); ?>
