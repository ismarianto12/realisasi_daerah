                ...
                <div class="form-row form-inline">
                    <div class="col-md-12">
                        ...
                        <div class="form-group m-0">
                            ...
                            <label class="r-0 s-12 col-md-8 tl"><?php echo e('[ '.$tmrekening_akun_kelompok_jenis_objek_rincian->tmrekening_akun_kelompok_jenis_objek->tmrekening_akun_kelompok_jenis->kd_rek_jenis.' ] '.$tmrekening_akun_kelompok_jenis_objek_rincian->tmrekening_akun_kelompok_jenis_objek->tmrekening_akun_kelompok_jenis->nm_rek_jenis); ?></label>
                        </div>
                        <div class="form-group m-0">
                            <label class="col-form-label s-12 col-md-2"><strong>Rek. Obj :</strong></label>
                            <label class="r-0 s-12 col-md-8 tl"><?php echo e('[ '.$tmrekening_akun_kelompok_jenis_objek_rincian->tmrekening_akun_kelompok_jenis_objek->kd_rek_obj.' ] '.$tmrekening_akun_kelompok_jenis_objek_rincian->tmrekening_akun_kelompok_jenis_objek->nm_rek_obj); ?></label>
                        </div>
                        <div class="form-group m-0">
                            <label class="col-form-label s-12 col-md-2"><strong>Kode Rek. Rincian Obj :</strong></label>
                            <label class="r-0 s-12 col-md-8 tl"><?php echo e($tmrekening_akun_kelompok_jenis_objek_rincian->kd_rek_rincian_obj); ?></label>
                        </div>
                        <div class="form-group m-0">
                            <label class="col-form-label s-12 col-md-2 pl-0"><strong>Nama Rek. Rincian Obj :</strong></label>
                            <label class="r-0 s-12 col-md-8 tl"><?php echo e($tmrekening_akun_kelompok_jenis_objek_rincian->nm_rek_rincian_obj); ?></label>
                        </div>
                    </div>
                </div>
            </div>
