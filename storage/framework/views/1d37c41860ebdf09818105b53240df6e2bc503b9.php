    ...
    <div class="page-inner py-5">
        <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
            ...
            <div class="ml-md-auto py-2 py-md-0">
                ...
                <a href="#" to="<?php echo e(route('pegawai.create')); ?>" class="tambah btn btn-secondary btn-round">Tambah Data
...
<?php $__currentLoopData = $load_script; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $script): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
<?php echo $script ?>
...
<script>
    $(function () {
            ...
            $('#pegawai').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(Url('tmpegawai/api/data')); ?>",
                },
                columns: [
                {
                data: 'DT_RowIndex',
...
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\realisasi_daerah\resources\views/tmpegawai/tmpegawai_list.blade.php ENDPATH**/ ?>