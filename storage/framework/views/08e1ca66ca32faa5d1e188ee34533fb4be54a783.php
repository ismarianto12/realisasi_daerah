<?php $__env->startSection('title','Edit Profile User .'); ?>
    ...
    <div class="col-md-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form id="exampleValidation" action="<?php echo e($action); ?>" method="POST" class="simpan"
                        ...
                        <div class="form-group form-show-validation row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" class="form-control" placeholder="username" aria-label="username"
                                    ...
                                    value="<?php echo e($username); ?>" readonly="true">
                            </div>
                        </div>
                        ...
                        <div class="form-group form-show-validation row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" class="form-control" id="telp" name="telp"
                                    placeholder="Masukan Nomor Telp" required value="<?php echo e($telp); ?>">
                            </div>
                        </div>
                            ...
                            <div class="col-sm-8">
                                <div class="input-file input-file-image">
                                    <img class="img-upload-preview img-circle" id="foto" width="100" height="100"
                                        src="<?php echo e($photo); ?>" alt="preview" onerror="this.src='<?php echo e(asset('assets/template/img/no-image.png')); ?>'">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\realisasi_daerah\resources\views/profile/index.blade.php ENDPATH**/ ?>