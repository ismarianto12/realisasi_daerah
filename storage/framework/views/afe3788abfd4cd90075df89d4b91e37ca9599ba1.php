...
<div class="page bg-light">
    <div class="container-fluid my-3">
        ...
        <div class="card">
            <div class="card-body">
                <h3>Setting Akses <?php echo e($nama_rincian); ?></h3>
                <br />
                <br /> 
...
<script type="text/javascript">
    ...
    var table = $('#datatable').DataTable({
        ...
        pageLength: 50,
        ajax: {
            url: "<?php echo e(route('settingrek.api_data_setting_sub',$rincian_id)); ?>",
            method: 'POST',
            data:function(data){
    ...
    function del_cancel(){
        ...
        if(c.length == 0){
            ...
            $.post("<?php echo e(route('settingrek.batalkan_sub', ':id')); ?>", {'_method' : 'POST', 'id' : c}, function(data) {
...
$('#simpandata').on('click', function (event) { 
    ...
    if(c.length == 0){
       ...
       $.post("<?php echo e(route('settingrek.update_rincian_sub', ':id')); ?>",
                 {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\realisasi_daerah\resources\views/settingrek/index_rincian.blade.php ENDPATH**/ ?>