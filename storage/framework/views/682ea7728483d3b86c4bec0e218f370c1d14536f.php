...
<body class="login">
    <div class="wrapper wrapper-login wrapper-login-full p-0">
        <div class="login-aside w-50 d-flex flex-column align-items-center justify-content-center text-center" style="
            ...
            <img src="<?php echo e(asset('/assets/template/img/tangsel.png')); ?>" class="img-responsive"
                        ...
                        <div class="form-group">
                            <select class="form-control" name="year" required="">
                                <?php
                                    $nexyear = date('Y');
                                ?>
                                <?php $__currentLoopData = range(2020, ++$nexyear); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lstahun): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\wamp64\www\realisasi_daerah\resources\views/auth/login.blade.php ENDPATH**/ ?>