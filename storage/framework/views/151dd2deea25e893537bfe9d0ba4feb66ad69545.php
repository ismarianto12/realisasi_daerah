...
<script>
    $(function(){     
        ...
        //jumlmah hari ini
        $.getJSON('<?php echo e(Url("api_grafik/total_pad?tanggal_lapor=1")); ?>',function(data){ 
            $('.tpadharini').text(data.total);
        });
     
        $.getJSON('<?php echo e(Url("api_grafik/jumlah_rek?jenis=1")); ?>',function(data){
         rek_obj = data.data;
         Circles.create({
            id: 'circles-1',
            radius: 45,
        ...
        $.getJSON('<?php echo e(Url("api_grafik/jumlah_rek?jenis=2")); ?>',function(data){
            rek_jenis = data.data;
