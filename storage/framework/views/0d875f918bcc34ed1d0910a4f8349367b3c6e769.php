    ...
    $('#modal_loader').modal('show');  
        ...
        if(c.length == 0){
           ...
           // var tgl_lapor = $('input:checked').data('tgl_lapor');
             var tgl_lapor      =  $('#tgl_lapor').val();   
            $.post("<?php echo e(route($route.'destroy', [':id'])); ?>&tgl_lapor="+tgl_lapor, {'_method' : 'DELETE', 'id' : c}, function(data) {
                if(data){
                    $.each(data, function(index, value){
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Xampp72\htdocs\realisasi_daerah\resources\views/pendapatan/pendapatan/index.blade.php ENDPATH**/ ?>