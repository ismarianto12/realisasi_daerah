...
<div class="page-inner mt--5">
    <div class="row mt--2">
        ...
        <div class="col-md-6">
            <div class="card full-height">
                <div class="card-body">
                    <div class="card-title">Realisasi {{ Properti_app::getTahun()  }}</div>
                    <div class="row py-3">
                        <div class="col-md-12">
...
<script>
    $(function(){
        ...
        $('#Lispersentase').html("<center><img src='https://icon-library.com/images/spinner-icon-gif/spinner-icon-gif-9.jpg' class='img-responsive'></center>").load('{{ route('homeAll') }}');
     })
