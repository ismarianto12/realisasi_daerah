                    ...
                    <div class="col-md-8">
                        <div class="form-group m-0">
                            ...
                            <div class="col-md-4 p-0 mb-2">
                                <select name="tmrapbd_id" id="tmrapbd_id" placeholder="" class="form-control select2 r-0 light" autocomplete="off" onchange="selectOnChange()">
                        ...
                        <div class="form-group m-0">
                            ...
                            <div class="col-md-8 p-0 mb-2">
                                <select name="tmsikd_satker_id" id="tmsikd_satker_id" class="form-control select2 r-0 light" required onchange="selectOnChange('tmsikd_satker_id')">
                        ...
                        <div class="form-group m-0">
                            ...
                            <div class="col-md-6 p-0 mb-2">
                                <select name="tmsikd_sub_skpd_id" id="tmsikd_sub_skpd_id" class="form-control select2s r-0 light" onchange="selectOnChange('tmsikd_sub_skpd_id')">
                        ...
                        <div class="form-group m-0">
                            ...
                            <div class="col-md-6 p-0 mb-2">
                                <select name="tmsikd_bidang_id" id="tmsikd_bidang_id" class="form-control select2s r-0 light" onchange="selectOnChange('tmsikd_bidang_id')">
...
<script type="text/javascript">
    ...
    function selectOnChange(){
        ...
        document.location.href = "{{ route($route.'index') }}?tahun_id=" + tahun_id + "&tmrapbd_id=" + tmrapbd_id + "&tmsikd_satker_id=" + tmsikd_satker_id + "&tmsikd_sub_skpd_id=" + tmsikd_sub_skpd_id + "&tmsikd_bidang_id=" + tmsikd_bidang_id;
    }
</script>
@endsection
