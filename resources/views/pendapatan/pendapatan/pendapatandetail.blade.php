...
<a href="{{ Url('pendapatan/'.$pendapatan_id.'/edit?satker_id='.$data->tmsikd_satker_id.'&tanggal_lapor='.$data->tanggal_lapor) }}" class="btn btn btn-warning" target="_blank"><i class="fa fa-edit"></i>Edit data</a>
</div> 
<hr />
