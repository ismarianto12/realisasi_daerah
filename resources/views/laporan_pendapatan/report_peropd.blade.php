    ...
    <div class="panel-header bg-primary-gradient">
        <div class="page-inner py-5">
            <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                <div>
                    <h2 class="text-white pb-2 fw-bold">Laporan Penerimaan</h2>
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="card-body">
                        ...
                        <div class="col-md-12">
                            <div class="form-group form-show-validation row">
                                <label for="tmrekening_akun_id" class="col-md-3 text-right"><strong>Rek.
                                        Akun </strong></label>
                                <div class="col-sm-4">
                                    <select name="tmrekening_akun_id" class="form-control select2" id="tmrekening_akun_id">
                            ...
                            <div class="form-group form-show-validation row">
                                <label for="tmrekening_akun_kelompok_id" class="col-md-3 text-right"><strong>Rek.
                                        Kelompok</strong></label>
                                <div class="col-sm-4">
                                    <select name="tmrekening_akun_kelompok_id" class="form-control select2"
                            ...
                            <div class="form-group form-show-validation row">
                                <label for="tmrekening_akun_kelompok_jenis_id" class="col-md-3 text-right"><strong>Rek.
                                        Jenis</strong></label>
                                <div class="col-sm-4">
                                    <select name="tmrekening_akun_kelompok_jenis_id" class="form-control select2"
                            ...
                            <div class="form-group form-show-validation row">
                                <label for="tmrekening_akun_kelompok_jenis_id" class="col-md-3 text-right"><strong>Jenis
                                        file</strong></label>
                                <div class="col-sm-4">
        ...
        $(function() {
            $('#tmrekening_akun_id').on('change', function() {
                ...
                if (val == "") {
                    ...
                    url = "{{ route('rekening.kodejenis.kodekelompokByKodeakun', ':id') }}".replace(':id',
                        val);
            ...
            $('#tmrekening_akun_kelompok_id').on('change', function() {
                ...
                if (val == "") {
                    ...
                    url = "{{ route('rekening.kodeobjek.kodejenisByKodekelompok', ':id') }}".replace(':id',
                        val);
                    $.get(url, function(data) {
                        if (data) {
                            $.each(data, function(index, value) {
            ...
            $('#tmrekening_akun_kelompok_jenis_id').on('change', function() {
                ...
                if (val == "") {
                    ...
                    url = "{{ route('rekening.koderincianobjek.kodeobjekByKodejenis', ':id') }}".replace(
                        ':id', val);
                    $.get(url, function(data) {
                        if (data) {
                            $.each(data, function(index, value) {
            ...
            $('#tampilkan').click(function(e) {
                ...
                if (tmsikd_satker_id == '') {
                    ...
                    if (jenis == '' || jenis == 0) {
                        ...
                        if (jenis == 'pdf') {
                            window.open("{{ route('laporan.action_all') }}?tahun_id=" + tahun_id +
                                "&tmsikd_satker_id=" + tmsikd_satker_id + "&dari=" + dari + "&sampai=" +
                                sampai + "&rekjenis_id=" + rekjenis_id + '&jenis=' + jenis, '_blank');
                        } else {
                            window.location.href = "{{ route('laporan.action_all') }}?tahun_id=" +
                                tahun_id + "&tmsikd_satker_id=" + tmsikd_satker_id + "&dari=" + dari +
                                "&sampai=" + sampai + "&rekjenis_id=" + rekjenis_id + '&jenis=' + jenis;
                        }
                    }
                }
            })
